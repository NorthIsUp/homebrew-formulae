cask 'gitx-gitx' do
  # github.com/gitx/gitx was verified as official when first introduced to the cask
  if MacOS.version <= :snow_leopard
    ...
    url "https://github.com/gitx/gitx/releases/download/build/#{version.major_minor}/#{version.patch}/GitX-dev-#{version.patch}.dmg"
  end
